...
asn_comp_rval_t * 
SupportedBandUTRA_TDD384_compare(asn_TYPE_descriptor_t *td1,
		const void *structure1,
		asn_TYPE_descriptor_t *td2,
		const void *structure2) {
	asn_comp_rval_t * res  = NULL;
	SupportedBandUTRA_TDD384_1_inherit_TYPE_descriptor(td1);
	SupportedBandUTRA_TDD384_1_inherit_TYPE_descriptor(td2);
...
asn_TYPE_descriptor_t asn_DEF_SupportedBandUTRA_TDD384 = {
	...
	SupportedBandUTRA_TDD384_compare,
