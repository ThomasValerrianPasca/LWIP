...
asn_comp_rval_t * 
CQI_ReportModeAperiodic_compare(asn_TYPE_descriptor_t *td1,
		const void *structure1,
		asn_TYPE_descriptor_t *td2,
		const void *structure2) {
	asn_comp_rval_t * res  = NULL;
	CQI_ReportModeAperiodic_1_inherit_TYPE_descriptor(td1);
	CQI_ReportModeAperiodic_1_inherit_TYPE_descriptor(td2);
...
asn_TYPE_descriptor_t asn_DEF_CQI_ReportModeAperiodic = {
	...
	CQI_ReportModeAperiodic_compare,
