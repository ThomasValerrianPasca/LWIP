...
asn_comp_rval_t * 
SupportedBandUTRA_TDD128_compare(asn_TYPE_descriptor_t *td1,
		const void *structure1,
		asn_TYPE_descriptor_t *td2,
		const void *structure2) {
	asn_comp_rval_t * res  = NULL;
	SupportedBandUTRA_TDD128_1_inherit_TYPE_descriptor(td1);
	SupportedBandUTRA_TDD128_1_inherit_TYPE_descriptor(td2);
...
asn_TYPE_descriptor_t asn_DEF_SupportedBandUTRA_TDD128 = {
	...
	SupportedBandUTRA_TDD128_compare,
