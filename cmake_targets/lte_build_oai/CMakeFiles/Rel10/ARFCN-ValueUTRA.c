...
asn_comp_rval_t * 
ARFCN_ValueUTRA_compare(asn_TYPE_descriptor_t *td1,
		const void *structure1,
		asn_TYPE_descriptor_t *td2,
		const void *structure2) {
	asn_comp_rval_t * res  = NULL;
	ARFCN_ValueUTRA_1_inherit_TYPE_descriptor(td1);
	ARFCN_ValueUTRA_1_inherit_TYPE_descriptor(td2);
