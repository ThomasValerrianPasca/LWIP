...
static asn_TYPE_tag2member_t asn_MAP_ext1_tag2el_15[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 } /* uplinkPowerControlCommon-v1020 at 2408 */
};
...
static asn_TYPE_member_t asn_MBR_RadioResourceConfigCommon_1[] = {
	...
	{ ATF_POINTER, 1, offsetof(struct RadioResourceConfigCommon, ext1),
		(ASN_TAG_CLASS_CONTEXT | (12 << 2)),
		0,
		&asn_DEF_ext1_15,
		0,	/* Defer constraints checking to the member type */
...
static asn_TYPE_tag2member_t asn_MAP_RadioResourceConfigCommon_tag2el_1[] = {
    ...
    { (ASN_TAG_CLASS_CONTEXT | (12 << 2)), 12, 0, 0 } /* ext1 at 2408 */
};
