...
static asn_comp_rval_t * 
si_RequestForHO_r9_37_compare(asn_TYPE_descriptor_t *td1,
		const void *structure1,
		asn_TYPE_descriptor_t *td2,
		const void *structure2) {
	asn_comp_rval_t * res  = NULL;
	si_RequestForHO_r9_37_inherit_TYPE_descriptor(td1);
	si_RequestForHO_r9_37_inherit_TYPE_descriptor(td2);
	res = td1->compare(td1, structure1, td2, structure2);
	return res;
}
...
static asn_comp_rval_t * 
reportQuantityUTRA_FDD_r10_40_compare(asn_TYPE_descriptor_t *td1,
		const void *structure1,
		asn_TYPE_descriptor_t *td2,
		const void *structure2) {
	asn_comp_rval_t * res  = NULL;
	reportQuantityUTRA_FDD_r10_40_inherit_TYPE_descriptor(td1);
	reportQuantityUTRA_FDD_r10_40_inherit_TYPE_descriptor(td2);
	res = td1->compare(td1, structure1, td2, structure2);
	return res;
}
...
asn_TYPE_descriptor_t asn_DEF_reportQuantityUTRA_FDD_r10_40 = {
	...
	reportQuantityUTRA_FDD_r10_40_compare,
	0,	/* Use generic outmost tag fetcher */
