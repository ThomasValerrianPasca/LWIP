...
static asn_TYPE_tag2member_t asn_MAP_ext1_tag2el_17[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* q-QualMin-r9 at 1592 */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 } /* threshX-Q-r9 at 1594 */
};
...
static asn_TYPE_member_t asn_MBR_InterFreqCarrierFreqInfo_1[] = {
	...
	{ ATF_POINTER, 4, offsetof(struct InterFreqCarrierFreqInfo, q_OffsetFreq),
	...
	{ ATF_POINTER, 3, offsetof(struct InterFreqCarrierFreqInfo, interFreqNeighCellList),
	...
	{ ATF_POINTER, 2, offsetof(struct InterFreqCarrierFreqInfo, interFreqBlackCellList),
	...
	{ ATF_POINTER, 1, offsetof(struct InterFreqCarrierFreqInfo, ext1),
		(ASN_TAG_CLASS_CONTEXT | (14 << 2)),
		0,
		&asn_DEF_ext1_17,
		0,	/* Defer constraints checking to the member type */
...
static int asn_MAP_InterFreqCarrierFreqInfo_oms_1[] = { 2, 4, 9, 11, 12, 13, 14 };
...
static asn_TYPE_tag2member_t asn_MAP_InterFreqCarrierFreqInfo_tag2el_1[] = {
    ...
    { (ASN_TAG_CLASS_CONTEXT | (14 << 2)), 14, 0, 0 } /* ext1 at 1592 */
};
