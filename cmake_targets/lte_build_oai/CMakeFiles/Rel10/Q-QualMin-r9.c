...
asn_comp_rval_t * 
Q_QualMin_r9_compare(asn_TYPE_descriptor_t *td1,
		const void *structure1,
		asn_TYPE_descriptor_t *td2,
		const void *structure2) {
	asn_comp_rval_t * res  = NULL;
	Q_QualMin_r9_1_inherit_TYPE_descriptor(td1);
	Q_QualMin_r9_1_inherit_TYPE_descriptor(td2);
