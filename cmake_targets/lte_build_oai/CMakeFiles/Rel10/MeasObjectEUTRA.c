...
static asn_TYPE_tag2member_t asn_MAP_ext1_tag2el_13[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* measCycleSCell-r10 at 3268 */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 } /* measSubframePatternConfigNeigh-r10 at 3269 */
};
...
static asn_TYPE_member_t asn_MBR_MeasObjectEUTRA_1[] = {
	...
	{ ATF_POINTER, 7, offsetof(struct MeasObjectEUTRA, offsetFreq),
	...
	{ ATF_POINTER, 6, offsetof(struct MeasObjectEUTRA, cellsToRemoveList),
	...
	{ ATF_POINTER, 5, offsetof(struct MeasObjectEUTRA, cellsToAddModList),
	...
	{ ATF_POINTER, 4, offsetof(struct MeasObjectEUTRA, blackCellsToRemoveList),
	...
	{ ATF_POINTER, 3, offsetof(struct MeasObjectEUTRA, blackCellsToAddModList),
	...
	{ ATF_POINTER, 2, offsetof(struct MeasObjectEUTRA, cellForWhichToReportCGI),
...
static int asn_MAP_MeasObjectEUTRA_oms_1[] = { 4, 5, 6, 7, 8, 9, 10 };
...
static asn_TYPE_tag2member_t asn_MAP_MeasObjectEUTRA_tag2el_1[] = {
    ...
    { (ASN_TAG_CLASS_CONTEXT | (10 << 2)), 10, 0, 0 } /* ext1 at 3268 */
};
